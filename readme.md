# HDI_ConnectGithubWithOauth2 

Manage an OAuth 2.0 connection (4D v20 R2) 

Find more information on the [blog post](https://blog.4d.com/4d-netkit-enhancement-of-oauth2-authorization/).
